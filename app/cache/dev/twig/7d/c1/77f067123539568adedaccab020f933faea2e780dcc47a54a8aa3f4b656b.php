...
/* VoyageBundle:Proposition:new.html.twig */
class __TwigTemplate_7dc177f067123539568adedaccab020f933faea2e780dcc47a54a8aa3f4b656b extends Twig_Template
{
...
<div class=\"content booking_wrap\">
    <div class=\"container\">
        ...
        echo "\" method=\"post\">
                                    ...
                                    <div id=\"voyage_firstbundle_proposition\">
                                        <div>
                                            <label for=\"voyage_firstbundle_proposition_nom\" class=\"required\">Nom</label>
                                            <input type=\"text\" autofocus  placeholder=\"nom proposition\" required id=\"voyage_firstbundle_annonce_nom\" name=\"nom\"  maxlength=\"45\" />
                                        </div>

                                        <div>
                                            <label for=\"voyage_firstbundle_proposition_typeProposition\">Type proposition</label>
                                            <select required id=\"voyage_firstbundle_proposition_typeproposition\" name=\"typeAnnonce\" >
                                        ...
                                        <div>
                                            <label for=\"voyage_firstbundle_proposition_destination\" class=\"required\">Destination</label>
                                            <input type=\"text\"  placeholder=\"destination\"id=\"voyage_firstbundle_annonce_destination\" required name=\"destination\"  maxlength=\"20\" />
                                        </div>
                                        
                                        <div>
                                            <label for=\"voyage_firstbundle_proposition_image\" class=\"image\">Longitude</label>
                                            <input type=\"number\" id=\"voyage_firstbundle_annonce_image\" name=\"long\" required />
                                        </div>
                                        <div>
                                            <label for=\"voyage_firstbundle_annonce_image\" class=\"image\">Latitude </label>
                                            <input type=\"number\" id=\"voyage_firstbundle_annonce_image\" name=\"att\" required />
                                        </div>
                                        
                                        <div>
                                            <label for=\"voyage_firstbundle_annonce_depart\"  class=\"required\">Depart</label>
                                            <input type=\"text\" id=\"voyage_firstbundle_annonce_depart\" placeholder=\"depart\" required name=\"depart\"  maxlength=\"20\" />
                                        </div>
                                        
                                        <div>
                                            <label class=\"required\">Date allée</label>
                                            <input type=\"date\" required id=\"voyage_firstbundle_annonce_dateDeb\" name=\"dateDeb\" >
                                        </div>
                                        
                                        <div>
                                            <label class=\"required\">Date de retour</label>
                                            <input type=\"date\" required id=\"voyage_firstbundle_annonce_dateDeb\" name=\"dateFin\">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type=\"text\"  placeholder=\"hébergement\" id=\"voyage_firstbundle_annonce_hebergement\" required name=\"hebergement\" maxlength=\"20\" /></div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type=\"text\" autofocus required id=\"voyage_firstbundle_annonce_prix\" placeholder=\"prix\" name=\"prix\" maxlength=\"20\" /></div>
                                        ...
                                        <div>
                                            <button type=\"submit\" id=\"voyage_firstbundle_annonce_submit\" name=\"submit\">Create</button>
                                        </div>
 ...
 ";
    ...
    {
        return "VoyageBundle:Proposition:new.html.twig";
    }
